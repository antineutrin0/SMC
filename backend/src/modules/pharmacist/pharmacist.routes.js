...
router.use(verifyToken, requireRole("Registrar", "Doctor"));
...
// Inventory
router.post("/inventory", validate(["medicineId", "quantity", "expDate"]), ctrl.addInventory);
...
router.patch("/first-aid/:id",    validate(["status"]), ctrl.reviewFirstAidRequest);
